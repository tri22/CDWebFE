                ...
                {contentItems.map((item, idx) => (
                    <Row key={idx} className="align-items-center">
                        ...
                        <Col md={6} xs={12} className={`d-flex flex-column align-items-center ${item.reverse ? 'order-md-1' : ''}`}>
                            <h3 className="mb-2 sub-title">{item.title}</h3>
                            <p className="my-4 text-center sub-description">{item.description}</p>
                            <Button
                                variant="primary"
            ...
            <div className="sub-main-3 text-center">
                <Row className="justify-content-center">
                    <Col xs={12} md={6} lg={5} className="sub-main-item">
                        ...
                        <p className="sub-main-date">29 sep, 2022 / by rat</p>
                        <h2 className="sub-main-title">Your office should have only natural materials</h2>
                        <a className="sub-main-link" href="#">read more</a>
                    </Col>
                    <Col xs={12} md={6} lg={5} className="sub-main-item">
